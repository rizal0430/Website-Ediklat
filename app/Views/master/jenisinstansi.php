...
<div class="card-header bg-white d-flex justify-content-between align-items-center">
    <h6 class="mb-0 fw-bold">Jenis Instansi</h6>
...
<div class="modal-header">
    <h6 class="modal-title" id="modalTitle">Tambah Jenis Instansi</h6>
...
<div class="row mb-2">
    ...
    <div class="col-md-8">
        <label class="small">Nama Jenis Instansi</label>
...
document.getElementById('btnTambah').addEventListener('click', function () {
    modalTitle.innerText = 'Tambah Jenis Instansi';
...
document.querySelectorAll('.btn-edit').forEach(btn => {
    btn.addEventListener('click', function () {
        modalTitle.innerText = 'Edit Jenis Instansi';
        form.action = this.dataset.action;
