...
<div class="card shadow-sm">
    <div class="card-header bg-white">
        <h5 class="fw-bold mb-0 text-center">
            Laporan Pelatihan Eksternal Karyawan RSU PKU DELANGGU
        </h5>
    </div>
    ...
    <div class="card-body">
        ...
        <form method="GET" class="row g-2 mb-3">
            ...
            <div class="col-auto">
                ...
                <a href="<?= current_url() ?>" class="btn btn-sm btn-secondary">Reset</a>
            </div>

            <div class="col-auto ms-auto">
               <a href="<?= base_url('master/laporan/export_eksternal?' . $_SERVER['QUERY_STRING']) ?>"
