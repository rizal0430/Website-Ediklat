...
<div class="modal fade" id="modalForm">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="post" id="formTempatTidur">
                <div class="modal-header">
                    <h6 class="modal-title" id="modalTitle">Tambah Tempat Tidur</h6>
...
const form = document.getElementById('formTempatTidur');

document.getElementById('btnTambah').addEventListener('click', function () {
    modalTitle.innerText = 'Tambah Tempat Tidur';
...
document.querySelectorAll('.btn-edit').forEach(btn => {
    btn.addEventListener('click', function () {
        modalTitle.innerText = 'Edit Tempat Tidur';
        form.action = this.dataset.action;
